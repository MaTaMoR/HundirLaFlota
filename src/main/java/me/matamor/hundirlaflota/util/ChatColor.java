...
public final class ChatColor {
    ...
    public static ChatColor valueOf(String name)
    {
        ...
        checkArgument( defined != null, "No enum constant " + ChatColor.class.getName() + "." + name );
    ...
    public int ordinal()
    {
        checkArgument( ordinal >= 0, "Cannot get ordinal of hex color" );
        return ordinal;
    }
    ...
    private static void checkArgument(boolean value, String msg) {
        if (!value) {
